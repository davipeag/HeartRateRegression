...
class BatchComputerPceDiscriminator(IBatchComputer):
    ...
    def compute_batch(self, batch) -> ModelOutput:
        xi1, yi1, xi2, yi2, lab = map(lambda v: v.to(self.device), batch)
        p = self.model(xi1,yi1,xi2, yi2)
        return ModelOutput((xi1,yi1,xi2, yi2), lab, p)
