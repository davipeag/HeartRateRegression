...
class DeepConvLstmFullTrainerHandChestAccelerometers(FullTrainers.SingleNetFullTrainerJointValidationXY):
    def __init__(
        self,
        dfs,
        device,
...
class SingleNoHrPpgPceLstmFullTrainerAddedFFT(FullTrainers.SingleNetFullTrainerJointValidationIS):
    def __init__(
        self,
        dfs,
        device,
        ...
        dataset_name,
        model_name = None,
        net_builder_cls = NoHrPceLstmModel.ppg_make_par_enc_pce_lstm_added_fft,
        transformer_getter_cls = TransformerGetters.PpgPceLstmTransformerGetterFftKeep ,
        input_features_parameter_name = "nattrs",
        additional_args = dict(),
        args_to_net_args_mapping = {"ts_per_is": "ts_per_is", "sample_per_ts": "sample_per_ts"},
        args_function_mapping = {"sample_per_ts": lambda a: a["frequency_hz"]*a["period_s"]}
...
class PceDeepDiscriminatorLstmFullTrainerHandChestAccelerometers(FullTrainers.PceDeepDiscriminatorAndLstmFullTrainerJointValidationIS):
    def __init__(
        ...
        model_name = "",
        frequency_hz = None,
        nets_builder_cls = PceLstmModel.parametrized_encoder_make_pce_lstm_and_discriminator,
        lstm_transformer_getter_cls = TransformerGetters.PceLstmTransformerGetterRenamed,
        discriminator_transformer_getter_cls = TransformerGetters.PceDiscriminatorTransformerGetter,
        input_features_parameter_name = "nattrs",
        additional_args = dict(),
        args_to_net_args_mapping = {"ts_per_is": "ts_per_is", "sample_per_ts": "sample_per_ts"},
        args_function_mapping = {"sample_per_ts": lambda a: a["frequency_hz"]*a["period_s"]}
        ...
        super().__init__(
            ...
            device = device,
            nepoch = nepoch,
            nets_builder_cls = nets_builder_cls,
            lstm_transformer_getter_cls = lstm_transformer_getter_cls,
            discriminator_transformer_getter_cls = discriminator_transformer_getter_cls,
            dataset_name = dataset_name,
            feature_columns = feature_columns,
            frequency_hz = frequency_hz,
            input_features_parameter_name = input_features_parameter_name,
...
class SingleZeroInitPceLstmFullTrainerHandChestAccelerometers(FullTrainers.SingleNetFullTrainerJointValidationIS):
    def __init__(
        self,
        dfs,
        device,
        ...
        frequency_hz = None,
        net_builder_cls = PceLstmModel.make_par_enc_no_pce_lstm,
        transformer_getter_cls = TransformerGetters.NoHrPceLstmTransformerGetterRenamed,
        input_features_parameter_name = "nattrs",
        additional_args = dict(),
        args_to_net_args_mapping = {"sample_per_ts": "sample_per_ts"},
        args_function_mapping = {"sample_per_ts": lambda a: a["frequency_hz"]*a["period_s"]}
